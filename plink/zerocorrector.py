...
zerocorrector.py corrects plink's filtering of r2 = 0 correlations by finding pairs without a reported r2 value
and adds them in with a value of zero.

(this script is hardcoded for a plink window size of 100000 - the ranger() function can be modified if necessary)

must take in input generated by r2corrector.R - this is because the plink files are not evenly
