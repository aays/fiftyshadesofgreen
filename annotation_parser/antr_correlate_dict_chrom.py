'''
modification of antr_correlate_dict.py that takes in a chromosome as input
...
parser.add_argument('-n', '--chromosome', required = True,
                   type = str, help = 'Name of chromosome, as it appears in the table.')
